    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-12">
        <button
          ...
          className="mb-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-indigo-600 bg-gray-100 hover:bg-gray-200"
        >
          Back to List
        </button>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <span className="text-sm text-gray-500">
                {selectedUser.completedProjects} projects completed
              </span>
          ...
          <div className="mt-6">
            <h3 className="text-lg font-medium text-gray-800">Hourly Rate</h3>
            <p className="text-lg text-gray-900">
              ${(Math.random() * 100).toFixed(0)}/hr
            </p>
          </div>
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700">
              {selectedUser.bio || "This freelancer hasn't provided a bio yet."}
            </p>
          </div>
