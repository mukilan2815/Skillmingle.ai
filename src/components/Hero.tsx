    ...
    <div className="relative overflow-hidden bg-gradient-to-b from-indigo-50 via-white to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="pt-20 pb-16 text-center lg:pt-32">
          ...
          >
            Connect with top talent using our advanced AI matching system. Secure blockchain payments, verified profiles, and seamless collaboration all in one place.
          </motion.p>
        ...
        >
          <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3">
            <div className="mx-auto flex max-w-xs flex-col gap-y-4">
              <dt className="text-base leading-7 text-gray-600">Active freelancers</dt>
              <dd className="order-first text-3xl font-semibold tracking-tight text-gray-900 sm:text-5xl">100,000+</dd>
            </div>
            <div className="mx-auto flex max-w-xs flex-col gap-y-4">
              <dt className="text-base leading-7 text-gray-600">Projects completed</dt>
              <dd className="order-first text-3xl font-semibold tracking-tight text-gray-900 sm:text-5xl">250,000+</dd>
            </div>
            <div className="mx-auto flex max-w-xs flex-col gap-y-4">
              <dt className="text-base leading-7 text-gray-600">Client satisfaction</dt>
        ...
        <div className="mt-24 grid grid-cols-1 gap-8 sm:grid-cols-3">
          ...
          >
            ...
            <h3 className="mt-4 text-xl font-semibold text-gray-900">AI-Powered Matching</h3>
            <p className="mt-2 text-gray-600">
              Our advanced AI algorithms ensure perfect project-talent matches every time.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="mt-2 text-gray-600">
              Blockchain-secured transactions ensure safe and transparent payments.
            </p>
          </motion.div>
